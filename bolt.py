...
class OTPMonitorBot:
    ...
    def format_message(self, sms_data, message_text, otp_code):
        ...
        client = self.escape_markdown(sms_data[4]) if len(sms_data) > 4 else 'N/A'
        cost = self.escape_markdown(sms_data[7]) if len(sms_data) > 7 else '$'
    ...
    def fetch_sms_data(self):
        ...
        headers = {
            ...
            'DNT': '1',
            'Referer': f'http://{self.target_host}/ints/agent/SMSCDRReports',
